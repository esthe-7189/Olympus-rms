...
<!-- <div id="loadingBar" style="LEFT:expression((document.body.clientWidth/2)); TOP:expression((document.body.clientHeight/2)); POSITION:absolute; z-index:1"> -->
<div id="loadingBar" >
...
<div id="main_container" >	
	...
	<div id="restofpage_big"  style="display:none" >
		<jsp:include page="<%= contentPage3 %>" flush="false"/>	
	</div>	
</div>
<script language="JavaScript">
document.getElementById('loadingBar').style.display="none";
document.getElementById('restofpage_big').style.display="";
</script>
</body>
</html>
