...
function newWin(url,w,h) {
	window.open(url,'','width='+w+',height='+h+',toolbars=no,menubars=no,scrollbars=no');
}

function newWin1(url,w,h) {
	window.open(url,'','width='+w+',height='+h+',toolbars=no,menubars=no,scrollbars=yes');
}
...
<form name="memberInput"  action="<%=urlPage%>rms/member/login.jsp" method="post"    >
  <tr>
    <td  align="center" valign=middle>
   <table width="656" height="426" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" background="<%=urlPage%>rms/image/user/loginbg_group.jpg">
...
<script language="JavaScript">
 ...
 function goPage(cookieName){
  ...
  frm.action="<%=urlPage%>rms/member/login.jsp";
  frm.submit();
 }
