...
frm.action = "<%=urlPage%>rms/admin/notice/add.jsp";	
frm.submit();	
...
<table width="95%"  class="tablebox" cellspacing="5" cellpadding="5">	
		<form action="<%=urlPage%>rms/admin/notice/add.jsp" method="post"  name="resultform"  >			
		<tr>
							...
							<td align="left"  style="padding-left:10px"   bgcolor="#F1F1F1"><font color="#CC0000">※</font>
									...
									<td align="left"  style="padding-left:10px"  >
										<input type="text" NAME="title"  VALUE=""  maxlength="120"  class="input02" style="width:400px">
