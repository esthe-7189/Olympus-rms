...
<%
  ...
  Calendar calen=Calendar.getInstance();   
   ...
   switch(day_of_week){
	...
	DataBeanHokoku mgrHokoku=mgrKin.getDbBogo02(Integer.parseInt(seq));
...
frm.action = "<%=urlPage%>rms/admin/hokoku/writeHoliBogo/updateBogo.jsp";	
frm.submit();
}
function goInit(){
	document.frm.reset();
...
<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);"><span class="calendar7">出張/休日勤務 > 休日出勤報告書 > 書き直す   </span> 
	...
	<form name="frm" action="<%=urlPage%>rms/admin/hokoku/writeHoliBogo/insertBogo.jsp" method="post" >
	 ...
	 <input type="hidden" name="fno" value="<%=seq%>">
			...
			<tr>
				...
				<td colspan="3" tyle="padding: 3 0 3 0">						
