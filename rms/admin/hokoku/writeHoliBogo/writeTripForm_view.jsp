...
/*	int levelKubun=0; if(dbPosiLevel!=1){levelKubun=dbPosiLevel;}
...
*/	
	...
	List listSignFix=managerSign.listSignFix(3,mseq);
...
frm.action = "<%=urlPage%>rms/admin/hokoku/writeHoliBogo/insertTrip.jsp";	
frm.submit();
}
...
<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);"><span class="calendar7">出張/休日勤務 > 休日出勤申請書 > 新規登録  </span> 
...
<table width="960"  class="tablebox" cellspacing="5" cellpadding="5">	
	<form name="frm" action="<%=urlPage%>rms/admin/writeHoliBogo/insertTrip.jsp" method="post" >
...
<c:if test="${! empty listSignFix}">
	...
	<c:if test="${empty listSignFix}">
		<input type="hidden" name="sign_yn" id="sign_yn" value="no">				
				<td> <a href="JavaScript:checkCodeWrite(6);" onfocus="this.blur();"><img src="<%=urlPage%>rms/image/admin/signLineMenu.jpg" ></a></td>		
			...
			<tr>
				...
				<td  colspan="3">
					<input type="text" size="15%" name='theday' id="theday" value="" style="text-align:center">  
			...
			<tr>
				...
				<td  colspan="3">
					<input type="text" size="2" name='plan_begin_hh' id="plan_begin_hh"  value="00" class="box" maxlength="2" style="width:25px"> 時
					<input type="text" size="2" name='plan_begin_mm' id='plan_begin_mm'  value="00" class="box" maxlength="2" style="width:25px"> 分 
					～
					<input type="text" size="2" name='plan_end_hh' id='plan_end_hh'  value="00" class="box" maxlength="2" style="width:25px"> 時
					<input type="text" size="2" name='plan_end_mm' id='plan_end_mm'  value="00" class="box" maxlength="2" style="width:25px"> 分
			...
			<tr>
				...
				<td  colspan="3">
					<input type="text" size="2" name='rest_begin_hh'  id='rest_begin_hh'  value="00" class="box" maxlength="2" style="width:25px"> 時
					<input type="text" size="2" name='rest_begin_mm' id='rest_begin_mm'  value="00" class="box" maxlength="2" style="width:25px"> 分 
					～
					<input type="text" size="2" name='rest_end_hh' id='rest_end_hh'   value="00" class="box" maxlength="2" style="width:25px"> 時
					<input type="text" size="2" name='rest_end_mm' id='rest_end_mm'  value="00" class="box" maxlength="2" style="width:25px"> 分
				...
				<td align="right"  colspan="3" style="padding: 0px 50px 0px 0px">						
...
function doSubmitOnEnter(){
	...
	frm.action = "<%=urlPage%>rms/admin/hokoku/writeHoliBogo/writeTripForm.jsp";	
	frm.submit();
}
