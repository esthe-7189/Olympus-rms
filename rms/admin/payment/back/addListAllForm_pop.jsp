...
<body LEFTMARGIN="0" TOPMARGIN="0" MARGINWIDTH="0" MARGINHEIGHT="0" background="" BORDER=0  align="center"  onLoad="javascript:resize('500','550') ;">
<center>
...
<form name="frmp" method="post" action="<%=urlPage%>admin/payment/addListAllForm_pop.jsp">    
    <input type="hidden" name="docontact"  id="docontact"  value="<%=docontact%>">
								<tr>								
									<td width="33%"><img src="<%=urlPage%>image/icon_s.gif" >支払周期</td>
									<td width="1%">:</td>
									<td width="66%">
	...
	<%if(docontact.equals("2")){%><option name="search_cond" VALUE="2"  selected>随時支払</option><%}else{%><option name="search_cond" VALUE="2"  >随時支払</option><%}%>											
								...
								<tr> 
									<td width="33%"><img src="<%=urlPage%>image/icon_s.gif" >取引先$</td>
									<td width="1%">:</td>
									<td width="66%">
