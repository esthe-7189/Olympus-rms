...
<form name="frmp" method="post" action="<%=urlPage%>admin/payment/addList_pop.jsp">
    ...
    <input type="hidden" name="docontact"  id="docontact"  value="<%=docontact%>">
								...
								<tr> 
									...
									<td>:</td>									
									<td><input type=text size="5" class="input02"  name="pay_kikan" maxlength="100"  value="${pay.pay_kikan}"></td>
								</tr>
								<tr> 
									<td><img src="<%=urlPage%>image/icon_s.gif" >支払日</td>
									<td>:</td>									
									<td><input type="text" size="8%" name="pay_day" id="pay_day" value="${pay.pay_day}" style="text-align:center" ></td>
								</tr>								
								<tr>									
								...
								<tr>									
									...
									<td>:</td>
									<td>									
									<c:if test="${pay.receive_yn_sinsei==1}">
										<input type="radio" name="receive_yn_sinsei"  value="1"  onfocus="this.blur()" checked  > 未確認 &nbsp;
										<input type="radio" name="receive_yn_sinsei"  value="2"  onfocus="this.blur()"  >確認
									</c:if>
									<c:if test="${pay.receive_yn_sinsei==2}">
										<input type="radio" name="receive_yn_sinsei"  value="1"  onfocus="this.blur()" > 未確認 &nbsp;
										<input type="radio" name="receive_yn_sinsei"  value="2"  onfocus="this.blur()"  checked>確認
									</c:if>
										<br>
		...
		<c:if test="${pay.mseq!=mem.mseq}">						            							
				<option value="${mem.mseq}" >${mem.nm}</option>	
								...
								<tr>	
									...
									<td>:</td>
									<td><input type="text" size="8%" name="post_send_day" id="post_send_day" value="${pay.post_send_day}" style="text-align:center" ></td>
								</tr>								
								<tr>
									...
									<c:if test="${pay.receive_yn_ot==2}">
										<input type="radio" name="receive_yn_ot"  value="1"  onfocus="this.blur()"   > 未受領 &nbsp;
										<input type="radio" name="receive_yn_ot"  value="2"  onfocus="this.blur()"  checked>受領完了	
									</c:if>																	
									</td>
								</tr>
								<tr>
