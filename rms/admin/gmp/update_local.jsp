...
out.println(pds.getKanri_no()+"</br>");
out.println(pds.getEda_no()+"</br>");
out.println(pds.getGigi_nm()+"</br>");
out.println(pds.getProduct_nm()+"</br>");
out.println(pds.getSeizomoto()+"</br>");
out.println(pds.getKatachi_no()+"</br>");
out.println(pds.getSeizo_no()+"</br>");
out.println(pds.getPlace()+"</br>");
out.println(pds.getSekining_nm()+"</br>");
out.println(pds.getHindo()+"</br>");
out.println(pds.getDate01()+"</br>");
out.println(pds.getDate02()+"</br>");
out.println(pds.getBseq()+"</br>");
