...
function goSignHokoku(seq,sign_ok) {	
	...
	document.memberInput.action = "<%=urlPage%>rms/admin/hokoku/writeHoliBogo/signOk.jsp";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="280" background="<%=urlPage%>rms/image/admin/titlePop_bg.gif" class="calendar5_03">
			<img src="<%=urlPage%>rms/image/icon_ball.gif" ><span class="calendar7">休日出勤申請書 > 決裁処理 </span> 
		</td>	
		<td width="70">
