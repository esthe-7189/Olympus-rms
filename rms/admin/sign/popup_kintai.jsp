...
DataBeanKintai pdb=mgrKin.getDb(Integer.parseInt(seq));
...
function goSign(seq,sign_ok) {	
	...
	document.memberInput.action = "<%=urlPage%>rms/admin/kintai/signOk.jsp";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="280" background="<%=urlPage%>rms/image/admin/titlePop_bg.gif" class="calendar5_03">
			<img src="<%=urlPage%>rms/image/icon_ball.gif" ><span class="calendar7">出退勤 > 決裁処理 </span> 
		</td>	
		<td width="70">
	...
	<tr>
		<td width="100%" align="center" colspan="3" >日付(出勤日) : <%=pdb.getHizuke()%></td>		
	</tr>
</table>
