...
var frmCate=document.memberInput;
	...
	with (document.memberInput) {
	 ...
	 if ( confirm("修正しますか?") != 1 ) { return; }	
     	frmCate.action = "<%=urlPage%>rms/admin/seizo/modifyUpload.jsp";	
	frmCate.submit();  
}
...
<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);"><span class="calendar7">製造記録書QA <font color="#A2A2A2">></font> 編集</span> 
...
<form name="memberInput" action="<%=urlPage%>rms/admin/seizo/modifyUpload.jsp" method="post" enctype="multipart/form-data" >	
	...
	<tr >
		...
		<td>
				<input type="radio" name="file_kind"  value="1"  onfocus="this.blur()"  checked>記録書原文(ORMS) &nbsp;
