...
function goWrite() {
    with (document.memberInput) {
     ...
     if ( confirm("登録しますか?") != 1 ) { return; }	
     	document.memberInput.action = "<%=urlPage%>rms/admin/seizo/upload_pop.jsp";	
...
<table width="90%" border=0 cellspacing=0 cellpadding=0 align=center class=c>
	<form name="memberInput" action="<%=urlPage%>rms/admin/seizo/upload_pop.jsp" method="post" enctype="multipart/form-data" >											
