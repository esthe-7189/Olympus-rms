...
function goWrite01(){	
	...
	frmL.action = "<%=urlPage%>rms/admin/seizo/cateInsert01_view.jsp";	
	frmL.submit();
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<form name="formlgroup" method="post"  action="<%=urlPage%>rms/admin/seizo/cateInsert01_view.jsp" onSubmit="return goWrite01(this)" >
