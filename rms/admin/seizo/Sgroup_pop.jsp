...
function goWrite03(groupId3,parentId3){	
	...
	document.move.action = "<%=urlPage%>rms/admin/seizo/cateInsert03_view.jsp";	
...
<form name="formsgroup" method=post action="<%=urlPage%>rms/admin/seizo/cateInsert03_view.jsp" onSubmit="return goWrite03(this)" >		
