...
<table width="100%" border="0" cellspacing="0" cellpadding="0">		
	<tr>		
		<td width="90%"  height="" style="padding: 5 0 0 20"  class="calendar7">
				...
				<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);">コメントリスト...
<c:choose>
...
<table width="95%"  border="0" cellspacing="0" cellpadding="0" align="center">
	<form name="frmList" action="<%=urlPage%>rms/admin/seizo/commentWrite_pop.jsp" method="post" >
...
<form name="move" method="post" >
	...
	<tr>
	<form name="search"  action="<%=urlPage%>rms/admin/seizo/commentList_pop.jsp" method="post">		
		 <input type="hidden" name="file_bseq" value="${param.file_bseq}"> 
...
function goPage(pageNo) {
    document.move.action = "<%=urlPage%>rms/admin/seizo/commentList_pop.jsp";
...
function goModify(bseq) {
	...
	document.move.action = "<%=urlPage%>rms/admin/seizo/commentLead_pop.jsp";
	frm.bseq.value=bseq;
	frm.pg.value="mody";	
  	frm.submit();
}
...
function goDelete(bseq,level,groupId) {
	...
	document.move.file_kind.value=<%=file_kind%>;			
    	document.move.action = "<%=urlPage%>rms/admin/seizo/commentDel_pop.jsp";	
    	document.move.submit();
}
...
<table width="90%" border="0" cellpadding="2" cellspacing="0">
		<tr>
		<td align=center>		
	  		<a href="javascript:opener.location.href='<%=urlPage%>rms/admin/seizo/listForm.jsp?page=<%=openerPg%>';window.close();"  onfocus="this.blur()"><img src="<%=urlPage%>rms/image/admin/btn_pop_close.gif" align="absmiddle"></a>		
		</td>
	</tr>
</table>
</center>
