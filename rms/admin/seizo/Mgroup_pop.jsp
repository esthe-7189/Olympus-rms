...
function goWrite02(){	
	...
	document.move.action = "<%=urlPage%>rms/admin/seizo/cateInsert02_view.jsp";	
...
<form name="formmgroup" method=post action="<%=urlPage%>rms/admin/seizo/cateInsert02_view.jsp" onSubmit="return goWrite02(this)" >		
