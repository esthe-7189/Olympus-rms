...
<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);"> <span class="calendar7">製造記録書QA  <font color="#A2A2A2">   >   </font> 新規登録</span> 	
...
<table width="850"  class="tablebox" cellspacing="5" cellpadding="5">	
	<form name="memberInput" method="post"  action="<%=urlPage%>rms/admin/seizo/upload.jsp" enctype="multipart/form-data">												
