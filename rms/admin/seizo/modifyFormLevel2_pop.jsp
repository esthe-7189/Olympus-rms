...
SeizoBean bunData=manager.getLevel(Integer.parseInt(bseq));
...
function goWrite() {    
  ...
  if ( confirm("修正しますか?") != 1 ) { return; }	
     	document.memberInput.action = "<%=urlPage%>rms/admin/seizo/modifyUpload_pop.jsp";	
...
<table width="90%" border=0 cellspacing=0 cellpadding=0 align=center class=c>
	<form name="memberInput" action="<%=urlPage%>rms/admin/seizo/modifyUpload_pop.jsp" method="post" enctype="multipart/form-data" >											
	...
	<tr >
		<td align="" bgcolor="#f7f7f7" style="padding: 5 5 5 5"><img src="<%=urlPage%>rms/image/icon_s.gif" >作業段階:</td>
