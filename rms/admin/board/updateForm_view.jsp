...
frm.action = "<%=urlPage%>admin/board/update.jsp";	
frm.submit();
}
function goInit(){
	var frm = document.memberInput;
...
<%}%>							
	...
	<font color="#A2A2A2">></font>修正</span> 
...
<table width="80%" class="box_100" cellspacing="2" cellpadding="2" >	
	<form name="memberInput" action="<%=urlPage%>admin/board/update.jsp" method="post"  onSubmit="" >
	...
	<tr >
		<td  width="15%" class="cho_06" style="padding: 3 3 3 8">Title</td>
		<td width="1%" class="cho_06" style="padding: 3 3 3 3">:</td>
		<td width="84%" style="padding: 3 3 3 3">
	...
	<tr >
		<td   class="cho_06" style="padding: 3 3 3 8">Name</td>
		<td  class="cho_06" style="padding: 3 3 3 3">:</td>
		<td  style="padding: 3 3 3 3"><input type="text" name="name" value="<%=member.getNm()%>" size="40" maxlength="50" class="input02" style="width:150px"></td>		
	</tr>
	<tr><td  background="<%=urlPage%>image/dot_line_all.gif" colspan="3"><td></tr>
	<tr >
		<td   class="cho_06" style="padding: 3 3 3 8">メインに公開</td>
		<td  class="cho_06" style="padding: 3 3 3 3">:</td>
		<td  style="padding: 3 3 3 3">
			<input type="radio" name="view_yn" value="1" <c:if test="${board.view_yn==1}">checked</c:if>>はい									
			<input type="radio" name="view_yn" value="2" <c:if test="${board.view_yn==2}">checked</c:if> >いいえ					
	<tr><td  background="<%=urlPage%>image/dot_line_all.gif" colspan="3"><td></tr>		
	<tr >
		<td   class="cho_06" style="padding: 3 3 3 8">メール返事</td>
		<td  class="cho_06" style="padding: 3 3 3 3">:</td>
		<td  style="padding: 3 3 3 3">
	<input type="radio" name="mail_yn" value="1" onClick="show01()" onfocus="this.blur()" <%if(mailyn==1){%>checked<%}%>><font  color="#FF6600">もらう</font>
	<input type="radio" name="mail_yn" value="2" onClick="show02()" onfocus="this.blur()"  <%if(mailyn==2){%>checked<%}%>><font  color="#FF6600">もらわない</font><br>
	...
	<tr >
		...
		<textarea id="content" name="content" style="width:100%;height:200px;"><%=conRe%></textarea>
...
<table align=center>									   
	<tr align="center">
			<td >	
    				<A HREF="JavaScript:goUpate()"><img src="<%=urlPage%>image/admin/btn_coment_editor.gif"></A>					
			</td>			
	</tr>
</form>
</table>			
