...
<form name="memberInput" action="<%=urlPage%>rms/admin/hinsithu/delete.jsp" method="post"  >											
	...
	上のファイルを削除すると <font color="#807265">QAチェック本(OT)	 / PG完成本(PG)	/最終完成本	</font>のファイルも一緒に削除されます。	
		</td>
	</tr>	
	</table>
	</td>
