...
var frmMail=document.mailCk;
   ...
   if(frm.mail_yn[0].checked == true){	
	...
	document.memberInput.action = "<%=urlPage%>rms/admin/hinsithu/commentModi_pop.jsp";	
...
<form name="memberInput" action="<%=urlPage%>rms/admin/hinsithu/commentModi_pop.jsp" method="post"  onSubmit="return goWrite(this)" >					
