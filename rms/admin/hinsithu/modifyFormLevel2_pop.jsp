...
HinsithuBean bunData=manager.getLevel(Integer.parseInt(bseq));
...
function goWrite() {    
  ...
  if ( confirm("修正しますか?") != 1 ) { return; }	
     	document.memberInput.action = "<%=urlPage%>rms/admin/hinsithu/modifyUpload_pop.jsp";	
...
<table width="90%" border=0 cellspacing=0 cellpadding=0 align=center class=c>
	<form name="memberInput" action="<%=urlPage%>rms/admin/hinsithu/modifyUpload_pop.jsp" method="post" enctype="multipart/form-data" >											
