...
<table width="95%"  border="0" cellspacing="0" cellpadding="0" align="center">
	<form name="frmList" action="<%=urlPage%>rms/admin/hinsithu/commentList_pop.jsp" method="post" >
...
<form name="memberInput" action="<%=urlPage%>rms/admin/hinsithu/commentInsert.jsp" method="post"  onSubmit="return goWrite(this)" >					
		<input type="hidden" name="file_bseq" value="<%=file_bseq%>">	
		<input type="hidden" name="file_kind" value="<%=file_kind%>">	
