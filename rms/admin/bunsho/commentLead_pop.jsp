...
var frmMail=document.mailCk;
   ...
   if(frm.mail_yn[0].checked == true){	
	...
	document.memberInput.action = "<%=urlPage%>rms/admin/bunsho/commentModi_pop.jsp";	
...
<form name="memberInput" action="<%=urlPage%>rms/admin/bunsho/commentModi_pop.jsp" method="post"  onSubmit="return goWrite(this)" >					
...
<script language="JavaScript">
 function goPgWrite() {
	var frm=document.memberInput;
	frm.action = "<%=urlPage%>rms/admin/bunsho/commentWrite_pop.jsp";	
	frm.pg.value="write";	
  	frm.submit();
}
 function goPgEditor () {
	var frm=document.memberInput;
	frm.action = "<%=urlPage%>rms/admin/bunsho/commentLead_pop.jsp";	
	frm.pg.value="mody";	
  	frm.submit();
}
function goPgList() {
	var frm=document.memberInput;
	frm.action = "<%=urlPage%>rms/admin/bunsho/commentList_pop.jsp";	
	frm.pg.value="List";	
  	frm.submit();
}
function goPgKotae() {
	var frm=document.memberInput;
	frm.action = "<%=urlPage%>rms/admin/bunsho/commentKotae_pop.jsp";	
	frm.pg.value="kotae";	
  	frm.submit();
}
 function goDelete(bseq,level,groupId) {
	...
	frm.file_kind.value=<%=file_kind%>;			
    	frm.action = "<%=urlPage%>rms/admin/bunsho/commentDel_pop.jsp";	
    	frm.submit();
}
</script>
<script type="text/javascript">
