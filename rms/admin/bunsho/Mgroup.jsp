...
function goWrite02(){	
	...
	document.move.action = "<%=urlPage%>rms/admin/bunsho/cateInsert02_view.jsp";	
...
<form name="formmgroup" method=post action="<%=urlPage%>rms/admin/bunsho/cateInsert02_view.jsp" onSubmit="return goWrite02(this)" >		
		<input type="hidden" name="groupId" value="">	
		<input type="hidden" name="parentId" value="${param.lgroup}">	
		<input type="hidden" name="level" value="2">			
	<tr>
	<td align="center">
	<select class="normal" style="border:0;HEIGHT:111px;WIDTH:600px;" onChange="doselectMcode();" multiple size=7 name="selectmg">		
...
中項目の新規登録:
<%		if(selectlgInt==0){%>
			<textarea name="name" cols="60" rows="2"  readOnly='true' ></textarea>				
		<%}else{%>
...
中項目の修正:
	<textarea name="name" cols="90" rows="2"><%=title%></textarea>	
