...
var frmCate=document.memberInput;	
   ...
   if ( confirm("上の内容を登録しますか?") != 1 ) { return; }	
     	frmCate.action = "<%=urlPage%>rms/admin/bunsho/upload.jsp";	
	frmCate.submit(); 
 }   
...
<table width="850"  class="tablebox" cellspacing="5" cellpadding="5">	
	<form name="memberInput" method="post"  action="<%=urlPage%>rms/admin/bunsho/upload.jsp" enctype="multipart/form-data">												
