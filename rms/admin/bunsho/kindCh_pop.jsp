...
function goWrite() {
    with (document.memberInput) {
     ...
     if ( confirm("登録しますか?") != 1 ) { return; }	
     	document.memberInput.action = "<%=urlPage%>rms/admin/bunsho/upload_pop.jsp";	
...
<table width="90%" border=0 cellspacing=0 cellpadding=0 >	
	<tr>
		<td width="100%"  height="30" style="padding: 0 0 0 0"  class="calendar7">
				...
				<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);">翻訳したファイルアップロード
    		</td>    	
	</tr>		
</table>	
<table width="90%" border=0 cellspacing=0 cellpadding=0 align=center class=c>
	<form name="memberInput" action="<%=urlPage%>rms/admin/bunsho/upload_pop.jsp" method="post" enctype="multipart/form-data" >											
