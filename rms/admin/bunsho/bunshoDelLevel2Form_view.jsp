...
if(fno==null){ fno="0";}
BunshoBean bunData=manager.getFile(Integer.parseInt(bseq));
...
<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);"><span class="calendar7">CHONDRON文書 <font color="#A2A2A2">></font> 削除 </span> 
...
<form name="memberInput" action="<%=urlPage%>rms/admin/bunsho/deleteLevel2.jsp" method="post"  >											
	...
	<tr>
		<td  style="padding: 3 0 3 5"><img src="<%=urlPage%>rms/image/shop/order_denger.gif" >上のファイルを削除すると<font color="#807265">
<c:choose>
