...
<form name="memberInput" action="<%=urlPage%>rms/admin/bunsho/delete.jsp" method="post"  >											
	...
	上のファイルを削除すると <font color="#807265">翻訳初本(NH) / PG完成本(PG)	/ORMS最終本(OR)	</font>のファイルも一緒に削除されます。	
		</td>
	</tr>	
	</table>
	</td>
