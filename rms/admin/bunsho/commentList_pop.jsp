...
<table width="95%"  border="0" cellspacing="0" cellpadding="0" align="center">
	<form name="frmList" action="<%=urlPage%>rms/admin/bunsho/commentWrite_pop.jsp" method="post" >
...
<form name="move" method="post" >
	...
	<tr>
	<form name="search"  action="<%=urlPage%>rms/admin/bunsho/commentList_pop.jsp" method="post">		
		 <input type="hidden" name="file_bseq" value="${param.file_bseq}"> 
...
function goPage(pageNo) {
    document.move.action = "<%=urlPage%>rms/admin/bunsho/commentList_pop.jsp";
...
function goModify(bseq) {
	...
	document.move.action = "<%=urlPage%>rms/admin/bunsho/commentLead_pop.jsp";
	frm.bseq.value=bseq;
	frm.pg.value="mody";	
  	frm.submit();
}
...
function goDelete(bseq,level,groupId) {
	...
	document.move.file_kind.value=<%=file_kind%>;			
    	document.move.action = "<%=urlPage%>rms/admin/bunsho/commentDel_pop.jsp";	
    	document.move.submit();
}
