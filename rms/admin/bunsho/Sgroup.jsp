...
function goWrite03(groupId3,parentId3){	
	...
	document.move.action = "<%=urlPage%>rms/admin/bunsho/cateInsert03_view.jsp";	
...
<form name="formsgroup" method=post action="<%=urlPage%>rms/admin/bunsho/cateInsert03_view.jsp" onSubmit="return goWrite03(this)" >		
		<input type="hidden" name="groupId" value="">	
		<input type="hidden" name="parentId" value="${param.mgroup}">	
		<input type="hidden" name="level" value="3">			
	<tr>
	<td align="center">
	<select class="normal" style="border:0;HEIGHT:111px;WIDTH:600px;" onChange="" multiple size=7 name="selectsg">		
