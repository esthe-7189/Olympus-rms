...
<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);"><span class="calendar7">CHONDRON文書 </span> 
...
<div id="boxNoLineBig"  >
	<div id="searchBox">				
		...
		<table  border="0" cellpadding="5" cellspacing="5" width="95%" >
			<form name="searchDate"   action="<%=urlPage%>rms/admin/bunsho/listForm.jsp" method="post"  >
				<tr>
...
<div class="clear_margin"></div>
 <table width="960">
 	 <form name="search"  action="<%=urlPage%>rms/admin/bunsho/listForm.jsp" method="post">	
		<tr>
			...
			<td width="50%" align="right">	
				...
				<input type="submit" class="cc" onfocus="this.blur();" style=cursor:pointer value="検索">
				<input type="button"  class="cc" onfocus="this.blur();" style=cursor:pointer value="全体リスト" onClick="location.href='<%=urlPage%>rms/admin/bunsho/listForm.jsp'">
			</td>
		</tr>
	</form>
</table>	
...
<tr height=26>		
	<td  align="center" width="4%"><font  color="#FF6600">(<%=count%>個)</font></td>
    	<td  align="center" width="96%"　colspan="1５"><span class="calendar7"> J P N</span> </td>
</tr>
</table>
...
<tr  align=center height=26 bgcolor="#eeeeee">	
    ...
    <td  width="15%">
		<table width=100% class="tablebox_list" cellpadding="1" cellspacing="1" >
			<tr  align=center height=26>	
				<td  align="center"  class="clear_dot_gray">韓国原文(SW)</td>
			</tr>			
	...
	<td width="15%">
		<table width=100% class="tablebox_list" cellpadding="1" cellspacing="1" >
		<tr  align=center height=26>	
				<td  align="center" class="clear_dot_gray">翻訳初本(NH)</td>
			</tr>			
			<tr height=2  style=color:#336699;>
				<td align="center"  ><font color="#0066FF">履歴</font></td>					
			</tr>
	...
	<td width="15%">
		<table width=100% class="tablebox_list" cellpadding="1" cellspacing="1" >
		<tr  align=center height=26>	
				<td  align="center" class="clear_dot_gray">PG完成本(PG)</td>
			</tr>			
			<tr height=2  style=color:#336699;>
				<td align="center"  ><font color="#0066FF">履歴</font></td>					
			</tr>
	...
	<td width="15%">
		<table width=100% class="tablebox_list" cellpadding="1" cellspacing="1" >
		<tr  align=center height=26>	
				<td  align="center" class="clear_dot_gray">ORMS最終本(OR)</td>
			</tr>			
			<tr height=2  style=color:#336699;>
				<td align="center"  ><font color="#0066FF">履歴</font></td>					
			</tr>
...
<%}%>
	...
	<%}%>
		...
		<%if (pdb.getKind_yn()==0){%>
			<a href="javascript:openScrollWin('<%=urlPage%>rms/admin/bunsho/kindCh_pop.jsp','read','상세보기','720','290',
					'&bseq=0&fileKind=2&fno=<%=or_seq %>');" onfocus="this.blur()">
			<img src="<%=urlPage%>rms/image/admin/btn_jp_mi.gif" align="absmiddle" alt="翻訳初本(NH)	へ"  title="翻訳初本(NH)へ"></a>
	...
	<!--	
		<a href="javascript:openScrollWin('<%=urlPage%>rms/admin/bunsho/commentList_pop.jsp','popUpdate','상세보기','720','400',
...
<c:if test="${! empty  kindbun}" >		
	...
	<%}%>		
		...
		<%if (kindbun.getKind_yn()==0){%>
			...
			<img src="<%=urlPage%>rms/image/admin/btn_jp_mi.gif" align="absmiddle" alt="PG完成本(PG)へ" title="PG完成本(PG)へ"></a>
			
		<%}%>
		<%if (kindbun.getKind_yn()==1){%><img src="<%=urlPage%>rms/image/admin/btn_jp_owari.gif" align="absmiddle"><%}%>
		
		<a href="javascript:openScrollWin('<%=urlPage%>rms/admin/bunsho/modifyFormLevel2_pop.jsp','popUpdate','상세보기','720','290',
...
<c:if test="${! empty  kindbun2}" >					
	...
	<%}%>	
		...
		<%if (kindbun2.getKind_yn()==0){%>
			...
			<img src="<%=urlPage%>rms/image/admin/btn_jp_mi.gif" align="absmiddle" alt="ORMS最終本(OR)	へ" title="ORMS最終本(OR)へ"></a>
...
function goPage(pageNo) {    
	...
	document.move.action = "<%=urlPage%>rms/admin/bunsho/listForm.jsp";
    	document.move.submit();
}
function goDelete(fno) {
	document.move.action = "<%=urlPage%>rms/admin/bunsho/bunshoDelForm.jsp";
	document.move.fno.value=fno;	
    	document.move.submit();
}
function goModify(fno) {	
    	document.move.action = "<%=urlPage%>rms/admin/bunsho/modifyForm.jsp";
	document.move.fno.value=fno;	
    	document.move.submit();
}
function goModifyLevel_2(fno,file_kind,bseq) {					
			var param="&fno="+fno+"&file_kind="+file_kind+"&bseq="+bseq;
			openNoScrollWin("<%=urlPage%>ms/admin/bunsho/modifyFormLevel2_pop.jsp", "update", "update", "720", "290", param);					
}
function goDeleteLevel2(fno,file_kind,bseq,parentId) {		
    	document.move.action = "<%=urlPage%>rms/admin/bunsho/bunshoDelLevel2Form.jsp";
	document.move.fno.value=fno;	
...
function goDown2(filename) {		
    	document.move.action = "<%=urlPage%>rms/admin/bunsho/down.jsp";
...
function goComment(fno,file_kind,bseq) {					
			...
			openNoScrollWin("<%=urlPage%>ms/admin/bunsho/comentList_pop.jsp", "update", "update", "720", "290", param);					
}
