...
FileUploadRequestWrapper requestWrap=new FileUploadRequestWrapper(
	request,-1,-1,"/home/user/orms/public_html/rms/temp","utf-8");
...
if (frmFileItem.getSize() >0){
	...
	//파일을 지정한 경로에 저장
	File fileNm=new File( "/home/user/orms/public_html/rms/admin/sop/fileList",fil);
	
	//같은 이름의 파일 처리
	if (fileNm.exists())	{
		for (int i=0;true ;i++ ){
			fileNm=new File("/home/user/orms/public_html/rms/admin/sop/fileList","("+i+")"+fil);
			if (!fileNm.exists()){
				fil="("+i+")"+fil;
				break;
			}
