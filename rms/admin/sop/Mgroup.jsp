...
int selectlgInt=Integer.parseInt(lgroup);
 ...
 int levelVal=0; int bseq=0; int cateNo=0; int bseq2=0;
String title="";
...
<link href="<%=urlPage%>orms/common/admin/css/style.css" rel="stylesheet" type="text/css">
<script language="JavaScript" src="<%=urlPage%>orms/common/admin/js/common.js"></script>
<script language="javascript" src="<%=urlPage%>orms/common/admin/js/Commonjs.js"></script>
	
<script language="javascript">
function goWrite02(){	
	var frmL = document.formmgroup;		
	var frmCate = parent.document.formcategory;	       	          
	...
	document.move.action = "<%=urlPage%>rms/admin/sop/cateInsert02_view.jsp";	
...
<form name="formmgroup" method=post action="<%=urlPage%>rms/admin/sop/cateInsert02_view.jsp" onSubmit="return goWrite02(this)" >		
...
%>	
				...
				<a href="javascript:goWrite02();" onfocus="this.blur()"><img src="<%=urlPage%>orms/images/admin/icon_write.gif"  align="absmiddle" alt="write"></a>
				<a href="javascript:goModify02('<%=cateNo%>');" onfocus="this.blur()"><img src="<%=urlPage%>orms/images/admin/icon_update.gif"  align="absmiddle" alt="modify"></a>	
				<a href="javascript:cateDel('<%=bseq2%>','<%=levelVal%>');"  onfocus="this.blur()"><img src="<%=urlPage%>orms/images/admin/icon_cancel.gif" align="absmiddle" alt="delete"></a>	
	          </div>
</form>	
	</td>
</tr>
...
<script language='JavaScript'>
//각 iframe의 url
var mgroupurl  = "<%=urlPage%>rms/admin/sop/Mgroup.jsp";
var sgroupurl  = "<%=urlPage%>rms/admin/sop/Sgroup.jsp";
var delpage= "<%=urlPage%>rms/admin/sop/cateDel.jsp";
var listForm="<%=urlPage%>rms/admin/sop/cateAddForm.jsp";
var modiOk="<%=urlPage%>rms/admin/sop/cateModi_02.jsp";
...
function cateDel(bseq2,level) {
	...
	document.formmgroup.bseqModi.value = bseq2;
    	document.formmgroup.level.value = level;
