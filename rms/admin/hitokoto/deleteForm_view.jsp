...
<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);"><span class="calendar7">管理者に一言 <font color="#A2A2A2">></font> 削除 </span> 
...
<table width="850"  class="tablebox" cellspacing="2" cellpadding="2">	
	<form action="<%=urlPage%>rms/admin/hitokoto/delete.jsp" method="post"  name="resultform"  >		
