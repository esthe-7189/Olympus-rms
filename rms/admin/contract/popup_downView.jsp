...
function goWrite() {	
 ...
 if(isEmpty(frm.pass, "パスワードを記入して下さい。")) return ; 
   ...
   if ( confirm("ダウンロードしますか?") != 1 ) {return ;}
	frm.action = "<%=urlPage%>rms/admin/contract/down.jsp";		
	frm.submit();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<form name="memberInput" action="<%=urlPage%>rms/admin/contract/down.jsp" method="post"  onSubmit="return goWrite(this)" >		
