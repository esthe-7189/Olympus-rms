...
frm.action = "<%=urlPage%>rms/admin/member/add.jsp";	
frm.submit();
}
//-->
</SCRIPT>
...
<div id="botton_position">	
	<input type="button"  class="cc" onfocus="this.blur();" style=cursor:pointer value=" 全体目録 " onClick="location.href='<%=urlPage%>rms/admin/member/listForm.jsp'">	
	<input type="button"  class="cc" onfocus="this.blur();" style=cursor:pointer value=" 新規登録 " onClick="location.href='<%=urlPage%>rms/member/writeForm.jsp'">			
</div>
<div id="boxNoLineBig"  >
...
<form name="memberInput" action="<%=urlPage%>rms/admin/member/add.jsp" method="post" enctype="multipart/form-data">
