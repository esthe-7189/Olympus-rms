...
frm.action = "<%=urlPage%>rms/admin/member/update_admin.jsp";	
frm.submit();
}
//-->
</SCRIPT>
...
<form name="memberInput" action="<%=urlPage%>rms/admin/member/update_admin.jsp" method="post" >	 
	...
	<tr>
		...
		<td   align="right">
			<%if(level==1){%>
				<a href="<%=urlPage%>rms/admin/member/listForm.jsp" onfocus="this.blur()">
				<img src="<%=urlPage%>rms/image/admin/btn_cate_list.gif" align="absmiddle" border="0" alt="List"></a>
				<input type="button"  class="cc" onfocus="this.blur();" style=cursor:pointer value="リスト" onClick="location.href='<%=urlPage%>rms/admin/member/listForm.jsp'">
			<%}else{%>
					.
			<%}%>
