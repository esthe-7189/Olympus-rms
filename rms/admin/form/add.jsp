...
String urlPage=request.getContextPath()+"/";
	...
	//String saveFold="C:\\dev\\tomcat5\\webapps\\orms\\rms\\admin\\form\\fileList";
	String saveFoldTemp="/home/user/orms/public_html/rms/temp";
	String saveFold="/home/user/orms/public_html/rms/admin/form/fileList";
...
request=requestWrap;
%>
<jsp:useBean id="pds" class="mira.form.FormBeen" >
...
FormManager mgr=FormManager.getInstance();
mgr.insertBoard(pds);

response.sendRedirect(urlPage+"rms/admin/form/listForm.jsp");
