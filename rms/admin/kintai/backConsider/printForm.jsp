...
<tr  align=center  onMouseOver=this.style.backgroundColor="#EFF5F9" onMouseOut=this.style.backgroundColor="">
	...
	<td align="center" class="calendar5" ><%=sum01_int/60%>:<%if(sum01_int%60==0){%><%=sum01_int%60%>0<%}else{%><%=sum01_int%60%><%}%> </td>
	<td align="center" class="calendar5"><%=sum02_int/60%>:<%if(sum02_int%60==0){%><%=sum02_int%60 %>0<%}else{%><%=sum02_int%60%><%}%></td>
