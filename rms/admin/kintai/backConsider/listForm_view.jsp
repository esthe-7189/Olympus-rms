...
<table width="960" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">  	
	...
	<tr>
		<td width="100%"  height="30" style="padding: 0 0 3 0"  class="calendar7">
    				<img src="<%=urlPage%>rms/image/icon_ball.gif" >
				<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=60);">  
<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);">出・退社管理
    		</td>    	
	</tr>		
</table>
<table width="80%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
	    <td width="70%"style="padding: 0 0 3 5">
	    	<font color="red">※</font>
...
<form name="frm" action="<%=urlPage%>rms/admin/kintai/insert.jsp" method="post" >
	 ...
	 <input type="hidden" name="emNumber" value="<%=member.getEm_number()%>">
	 <input type="hidden" name="simya_hh" value="00">
	 <input type="hidden" name="simya_mm" value="00">
...
<tr bgcolor="" align=center height=26>	
    <td  align="center" colspan="4" class="calendar5_03">ORMS<%=position%></td>
    <td  align="center" colspan="2" class="calendar5_01"><%=name%></td>
    <td  align="center" colspan="5" class="calendar5_01"><%=inDate%>(<%=m_week%>曜日)</td>
</tr>
<tr bgcolor=#F1F1F1 align=center height=26>	
    <td  align="center" width="9%">日付 </td>
    <td  align="center" width="5%">普通残業<br>FT過不足</td>    
    <td  align="center" width="7%"><font color="#FF6600">休日出勤</font></td>
    <td  align="center" width="7%">休暇</td>
    <td  align="center" width="8%">代休取得</td>
    <td  align="center" width="7%">遅刻・早退・<br>外出時間</td>    
    <td  align="center" width="17%">
		<table width=100% border=1 cellpadding=1 cellspacing=0 bordercolor=#FFFFFF bordercolorlight=#A2A2A2>
			<tr bgcolor=#F1F1F1 align=center height=26>	
				<td  align="center" >始業時間</td>
				<td  align="center" >終業時間</td>
			</tr>			
	...
	<td  align="center" width="7%">備考</td>
	<td  align="center" width="10%">決裁者</td>  
	<td  align="center" width="4%">登録</td>
</tr>
<tr >
	<td align="center"><input type="text" size="12%" name='hizuke' class=calendar value="<%=inDate%>" style="text-align:center"></td>
	<td align="center">
		<input type="text" size="2" onClick="javascript:sikpEvent();" readonly name='zangyo_hh'  value="00" class="box" maxlength="2" style="width:25px" >:<input type="text" size="2" onClick="javascript:sikpEvent();"　name='zangyo_mm'  value="00" class="box" maxlength="2" style="width:25px" readonly>
	</td>	
	<td align="center">			
		<input type="text" size="2"   name='holiday_hh'  value="00" class="box" maxlength="2" style="width:25px">:<input type="text" size="2"  name='holiday_mm'  value="00" class="box" maxlength="2" style="width:25px">
	</td>
	<td align="center">			
	...
	<td align="center">
		...
		<input type="text" size="12%" name='daikyu_date' class=calendar value="<%=inDate%>" style="text-align:center">
	</td>
	<td align="center">
<!--**>		<a onclick="ChikokuTime();" style="CURSOR: pointer;" >	
			<img src="<%=urlPage%>rms/image/admin/tokei.gif" align="absmiddle" alt="自動入力"></a>
<****-->
			<input type="text" size="2" name='chikoku_hh'  value="00" class="box" maxlength="2" style="width:25px">:<input type="text" size="2" name='chikoku_mm'  value="00" class="box" maxlength="2" style="width:25px">
	</td>
	<td align="center">
		<table width=100% border=1 cellpadding=1 cellspacing=0 bordercolor=#FFFFFF bordercolorlight=#A2A2A2>
			<tr bgcolor=#F1F1F1 align=center height=26>	
				<td  align="center" >
					<a onclick="StartTime();" style="CURSOR: pointer;" >	
			 		<img src="<%=urlPage%>rms/image/admin/tokei.gif" align="absmiddle" alt="自動入力"></a>
					<input type="text" size="2" name='begin_hh'  value="00" class="box" maxlength="2" style="width:25px">時
					<input type="text" size="2" name='begin_mm'  value="00" class="box" maxlength="2" style="width:25px">分
				</td>
				<td  align="center" >
					<a onclick="EndTime();" style="CURSOR: pointer;">	
			 		<img src="<%=urlPage%>rms/image/admin/tokei.gif" align="absmiddle" alt="自動入力"></a>
					<input type="text" size="2" name='end_hh'  value="00" class="box" maxlength="2" style="width:25px">時
					<input type="text" size="2" name='end_mm'  value="00" class="box" maxlength="2" style="width:25px">分
				</td>
			</tr>			
			<tr height=2 bgcolor=#F1F1F1 style=color:#336699;>
				<td align="center" colspan="2"><input type="text" name='riyu'  value="" class="box" maxlength="200" style="width:210px"></td>					
			</tr>
		</table>	
	</td>
	<td align="center"><textarea class="textarea2" name="comment" rows="4" cols="12"></textarea>
	</td>
<!--	
	<td align="center">
		<div  class="f_left" style="padding:2px;background:#EFEBE0;margin:0px 0px 0 0;">				
...
-->
	...
	<td align="center"><a href="JavaScript:goWrite()" onfocus="this.blur();"><img src="<%=urlPage%>rms/image/admin/btn_apply.gif" align="absmiddle" alt="send"></a>
	</td>
</tr>
</table>	
</form>	
...
<tr bgcolor=#E9FEEA align=center >	
    <td  align="center" width="9%" colspan="2">日付 </td>
    <td  align="center" width="6%">普通残業<br>FT過不足</td>    
    <td  align="center" width="8%">休日出勤</td>
    <td  align="center" width="8%">休暇</td>
    <td  align="center" width="8%">代休取得</td>
    <td  align="center" width="8%">遅刻・早退・<br>外出時間</td> 
	...
	<td  align="center" width="8%">備考</td>
	<td  align="center" width="7%">印</td>  
	<td  align="center" width="4%">修正・削除</td>
</tr>
...
<%if(hizukeYoubi.equals("日") || hizukeYoubi.equals("土") || yyCol.equals(yyHori) && mmCol.equals(mmHori) && ddCol.equals(ddHori) || mmCol.equals(mmHori) && ddCol.equals(ddHori)){%>		
				<td align="center" ><font color="red"><%=ddZero%></font></td>
				<td align="center" bgcolor=#F1F1F1 ><font color="red"><%=hizukeYoubi%></font></td>	
				<td align="center" bgcolor=#F1F1F1>&nbsp;</td>	
				<td align="center"  >														
					<%if(dbb.getOneday_holi().equals("0") && dbb.getDaikyu().equals("0")){%>
							<%=dbb.getHoliday_hh()%>:<%if(dbb.getHoliday_mm()==0){%><%=dbb.getHoliday_mm()%>0<%}else{%><%=dbb.getHoliday_mm()%><%}%>					
					<%}else if(dbb.getOneday_holi().equals("0") && !dbb.getDaikyu().equals("0")){%>
							&nbsp;					
					<%}else if(!dbb.getOneday_holi().equals("0") && dbb.getDaikyu().equals("0")){%>
							&nbsp;					
					<%}else{%>
...
<%if(!dbb.getDaikyu().equals("0")){%>
				<td align="center" title="<%=dbb.getDaikyu_date()%>" bgcolor=#F1F1F1><%=dbb.getDaikyu()%>
...
<%}else{%>
	<td align="center"><%=ddZero%></td>
	<td align="center"><%=hizukeYoubi%></td>	
	<td align="center">
		<%if(dbb.getOneday_holi().equals("0") && dbb.getDaikyu().equals("0")){%>
	...
	<%if(!dbb.getDaikyu().equals("0")){%>
			<td align="center" title="<%=dbb.getDaikyu_date()%>"><%=dbb.getDaikyu()%>
				<img style="CURSOR: pointer;" src="<%=urlPage%>rms/image/admin/memo_s.gif" align="absmiddle">
			</td>					
	<%}else{%>
		 <td align="center"> &nbsp;</td>
...
<%}%>			
	<td  align="center" width="17%">
		<table width=100% border=1 cellpadding=1 cellspacing=0 bordercolor=#FFFFFF bordercolorlight=#A2A2A2>
			<tr align=center height=26>	
				<td  align="center" width="50%"><%=dbb.getBegin_hh()%>:<%=beginZero%></td>
				<td  align="center" width="50%"><%=dbb.getEnd_hh()%>:<%=endZero%></td>				
			</tr>
			<tr>
	...
	<td align="center"><%=dbb.getComment()%></td>
	<td align="center">
<%
	...
	%>
		...
		<%if(dbb.getSign_ok()==3 ){%><font color="#007AC3"><%=memSign.getNm()%></font><br><font color="#BA7474">返還</font><%}%> 
	<%}}else{%>--
	<%}%>	
	</td>
	<td align="center">
...
function goDelete(seq,ymd) {
	   if ( confirm(ymd+"のデータを削除しましょうか?") != 1 ) {return ;}
