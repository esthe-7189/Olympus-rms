...
.tFontS {font-family:MS PGothic,Gulim,Dotum,Batang,Gungsuh,Arial,Comic Sans MS,Courier New;Tahoma,Times New Roman,Verdan; font-size:11px; color: #3C3C3C; text-decoration:none; }
</style>
...
<tr bgcolor=#E9FEEA align=center >	
    <td  align="center" width="7%" colspan="2" class="tFont">日付 </td>
    <td  align="center" width="7%" class="tFont">普通残業<br>FT過不足</td>    
    <td  align="center" width="7%" class="tFont">休日出勤</td>
    <td  align="center" width="7%" class="tFont">休暇</td>
    <td  align="center" width="10%" class="tFont">代休取得</td>
    <td  align="center" width="7%" class="tFont">遅刻・早退・<br>外出時間</td>   
    <td  align="center" width="7%" class="tFont" bgcolor="#84CC96">始業時間</td>
    <td  align="center" width="7%" class="tFont" bgcolor="#84CC96">終業時間</td>
    <td align="center" width="13%" class="tFont" bgcolor="#84CC96">理由</td>
    <td  align="center" width="6%" class="tFont">印</td>  	
</tr>
...
//'Calendar loop
	...
	String daikyu="0"; String daikyu_date="0"; int chikoku_hh=0; int chikoku_mm=0; int begin_hh=0; int end_hh=0;
//	String hizukeYoubi="";String yyCol=""; String mmCol=""; String ddCol=""; String ddColZero=""; 
	...
	cal.get(cal.MONTH)==1-1 && dispDay==2 || 
	cal.get(cal.MONTH)==1-1 && dispDay==3 ||
	cal.get(cal.MONTH)==1-1 && dispDay==4 ||	
	cal.get(cal.MONTH)==2-1 && dispDay==11 || 	
	cal.get(cal.MONTH)==4-1 && dispDay==29 || 
	cal.get(cal.YEAR)!=2012 && cal.get(cal.MONTH)==5-1 && dispDay==1  || 
	cal.get(cal.MONTH)==5-1 && dispDay==3  ||
	cal.get(cal.MONTH)==5-1 && dispDay==4  || 
	cal.get(cal.MONTH)==5-1 && dispDay==5  ||
	cal.get(cal.YEAR)!=2012 && cal.get(cal.MONTH)==7-1 && dispDay==18 || 	
	cal.get(cal.MONTH)==8-1 && dispDay==12 || 
	cal.get(cal.MONTH)==8-1 && dispDay==13 || 
	cal.get(cal.MONTH)==8-1 && dispDay==14 || 
	cal.get(cal.MONTH)==8-1 && dispDay==15 || 
	cal.get(cal.MONTH)==8-1 && dispDay==16 ||	
	cal.get(cal.YEAR)!=2012 && cal.get(cal.MONTH)==9-1 && dispDay==19 ||
	cal.get(cal.YEAR)!=2012 && cal.get(cal.MONTH)==9-1 && dispDay==23 ||		
	cal.get(cal.YEAR)!=2012 && cal.get(cal.MONTH)==10-1 && dispDay==10 ||
	cal.get(cal.MONTH)==11-1 && dispDay==3  || 
	cal.get(cal.MONTH)==11-1 && dispDay==23 ||
	cal.get(cal.MONTH)==12-1 && dispDay==23 ||
	cal.get(cal.MONTH)==12-1 && dispDay==29 ||
	cal.get(cal.MONTH)==12-1 && dispDay==30 ||	
	cal.get(cal.YEAR)==2011 && cal.get(cal.MONTH)==1-1 && dispDay==10 ||
	cal.get(cal.YEAR)==2011 && cal.get(cal.MONTH)==3-1 && dispDay==21 || 		
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==1-1 && dispDay==9 ||
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==2-1 && dispDay==11 || 
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==3-1 && dispDay==20 ||	
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==4-1 && dispDay==30 ||
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==7-1 && dispDay==16 || 
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==8-1 && dispDay==17 || 
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==9-1 && dispDay==17 ||
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==9-1 && dispDay==22 ||
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==10-1 && dispDay==8 ||
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==12-1 && dispDay==24 ||
	cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==12-1 && dispDay==31 ||
	cal.get(cal.YEAR)==2013 && cal.get(cal.MONTH)==1-1 && dispDay==14 ||
	cal.get(cal.YEAR)==2013 && cal.get(cal.MONTH)==3-1 && dispDay==20){ bgCol="#FFC286";  bgColElse="#D0D0D0"; bgColKyu="#ffffff"; jobTimeKubun="holi";}
%>
...
if(dbb !=null){	
	...
	if(jobTimeKubun.equals("holi")){
					if(member.getEm_number().equals("010")){	
					...
					if(jangyoPast495 <=0 && member.getEm_number().equals("010")){	
						...
						totalChikokuTime +=chikokuTime;						
					}else if(jangyoPast495 >0 && member.getEm_number().equals("010")){						
					...
					}else if(jangyoPast595 <=0 && !member.getEm_number().equals("010")){						
...
<!--******> 
<%if(cal.get(cal.MONTH)==1-1 && dispDay==1){%><font color="red">(元)</font><%}%>
	<%if(cal.get(cal.YEAR)==2011 && cal.get(cal.MONTH)==1-1 && dispDay==10){%><font color="#808000">(成)</font><%}%>
	<%if(cal.get(cal.MONTH)==1-1 && dispDay==1){%><font color="#808000">(年)</font><%}%>
	<%if(cal.get(cal.MONTH)==1-1 && dispDay==2){%><font color="#808000">(年)</font><%}%>
	<%if(cal.get(cal.MONTH)==1-1 && dispDay==3){%><font color="#808000">(年)</font><%}%>
	<%if(cal.get(cal.MONTH)==1-1 && dispDay==4){%><font color="#808000">(年)</font><%}%>
		
	<%if(cal.get(cal.MONTH)==2-1 && dispDay==11){%><font color="#808000">(建)</font><%}%>
	<%if(cal.get(cal.YEAR)==2011 && cal.get(cal.MONTH)==3-1 && dispDay==21){%><font color="#808000">(春)</font><%}%>
	<%if(cal.get(cal.MONTH)==4-1 && dispDay==29){%><font color="#808000">(昭) </font><%}%>
	<%if(cal.get(cal.MONTH)==5-1 && dispDay==3){%><font color="#808000">(憲)</font><%}%>
	<%if(cal.get(cal.MONTH)==5-1 && dispDay==4){%><font color="#808000">(み)</font><%}%>
	<%if(cal.get(cal.MONTH)==5-1 && dispDay==5){%><font color="#808000">(こども)</font><%}%>
	<%if(cal.get(cal.YEAR)!=2012 && cal.get(cal.MONTH)==7-1 && dispDay==18){%><font color="#808000">(海)</font><%}%>
	<%if(cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==7-1 && dispDay==16){%><font color="#808000">(海)</font><%}%>
	<%if(cal.get(cal.YEAR)!=2012 && cal.get(cal.MONTH)==9-1 && dispDay==19){%><font color="#808000">(敬)</font><%}%>
	<%if(cal.get(cal.YEAR)!=2012 && cal.get(cal.MONTH)==9-1 && dispDay==23){%><font color="#808000">(秋)</font><%}%>
	<%if(cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==9-1 && dispDay==17){%><font color="#808000">(敬)</font><%}%>
	<%if(cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==9-1 && dispDay==22){%><font color="#808000">(秋)</font><%}%>
	<%if(cal.get(cal.YEAR)!=2012 && cal.get(cal.MONTH)==10-1 && dispDay==10){%><font color="#808000">(体)</font><%}%>
	<%if(cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==10-1 && dispDay==8){%><font color="#808000">(体)</font><%}%>
	<%if(cal.get(cal.MONTH)==11-1 && dispDay==3){%><font color="#808000">(文)</font><%}%>
	<%if(cal.get(cal.MONTH)==11-1 && dispDay==23){%><font color="#808000">(勤)</font><%}%>
	<%if(cal.get(cal.MONTH)==12-1 && dispDay==23){%><font color="#808000">(天)</font><%}%>

	<%if(cal.get(cal.MONTH)==8-1 && dispDay==12){%><font color="#808000">(夏)</font><%}%>
	<%if(cal.get(cal.MONTH)==8-1 && dispDay==13){%><font color="#808000">(夏)</font><%}%>
	<%if(cal.get(cal.MONTH)==8-1 && dispDay==14){%><font color="#808000">(夏)</font><%}%>
	<%if(cal.get(cal.MONTH)==8-1 && dispDay==15){%><font color="#808000">(夏)</font><%}%>
	<%if(cal.get(cal.MONTH)==8-1 && dispDay==16){%><font color="#808000">(夏)</font><%}%>
	<%if(cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==8-1 && dispDay==17){%><font color="#808000">(夏)</font><%}%>
		
	<%if(cal.get(cal.MONTH)==12-1 && dispDay==29){%><font color="#808000">(年)</font><%}%>
	<%if(cal.get(cal.MONTH)==12-1 && dispDay==30){%><font color="#808000">(年)</font><%}%>
	<%if(cal.get(cal.MONTH)==12-1 && dispDay==31){%><font color="#808000">(年)</font><%}%>	
	
	<%if(cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==1-1 && dispDay==9){%><font color="#808000">(成)</font><%}%>
	<%if(cal.get(cal.YEAR)==2012 && cal.get(cal.MONTH)==3-1 && dispDay==20){%><font color="#808000">(春)</font><%}%>
	
	<%if(cal.get(cal.YEAR)==2013 && cal.get(cal.MONTH)==1-1 && dispDay==14){%><font color="#808000">(成)</font><%}%>
	<%if(cal.get(cal.YEAR)==2013 && cal.get(cal.MONTH)==3-1 && dispDay==20){%><font color="#808000">(春)</font><%}%>
	</td>
<******-->		
	...
	<td  style="padding:0 0 0 0" align="center" bgcolor="<%=bgColKyu%>" class="tFont">
		...
		<%}else if(jobTimeKubun.equals("holi") && seq!=0){%>
			<%=totalKyuHH_s%>:<%if(totalKyuMM_s==0){%><%=totalKyuMM_s%>0<%}else{%><%=totalKyuMM_s%><%}%> 
		<%}else if(seq==0){%>
			&nbsp; 
		<%}else{%>	
			&nbsp; 
	...
	<%}%>	
	<td  style="padding:0 0 0 0" align="center" bgcolor="<%=bgColElse%>" class="tFont">
		<%if(chikoku_hh==0 && chikoku_mm==0 && seq==0){%>
				&nbsp;			
	...
	<td   style="padding:0 0 0 0" align="left" class="tFontS">
		<%if(seq==0){%>
			&nbsp;
		<%}else{%>							
			<%if(riyu==null){%> &nbsp; 
...
<tr  align=center  onMouseOver=this.style.backgroundColor="#EFF5F9" onMouseOut=this.style.backgroundColor="">
	...
	<td align="center" class="calendar5" ><%=totalsum/60%>:<%if(totalsum%60==0){%><%=totalsum%60%>0<%}else{%><%=totalsum%60%><%}%> </td>
	<td align="center" class="calendar5"><%=totalKyusum/60%>:<%if(totalKyusum%60==0){%><%=totalKyusum%60 %>0<%}else{%><%=totalKyusum%60%><%}%></td>
	<td align="center" class="calendar5">&nbsp;</td>
	<td align="center" class="calendar5">&nbsp;</td>
	<td align="center" class="calendar5"><%=totalChikokuTime/60%>:<%if(totalChikokuTime%60==0){%><%=totalChikokuTime%60 %>0<%}else{%><%=totalChikokuTime%60%><%}%></td>
	<td align="center" class="calendar5">&nbsp;</td>
	<td align="center" class="calendar5">&nbsp;</td>
	<td align="center" class="calendar5">&nbsp;</td>
	<td align="center" class="calendar5">&nbsp;</td>	
