	 ...
	 if(document.getElementById(x).style.display == 'block'){
	  ...
	  if(document.getElementById("layerpop").style.display == 'block'){
        ...
        <div class="top_menu_cont" > 
    			...
    			<ul class="social">
    				<li><a class="homenav" href="<%=urlPage%>kaigi/admin/schedule/monthForm.jsp" onfocus="this.blur();" title="home">HOME</a></li>
    		
<%if(id !=null){
	if(kind.equals("kaigi")){%>							
		<%if(level==1){%>			
				<li><a class="homenav" href="http://weblog.olympus-rms.com/" onFocus="this.blur()"  target="_blank" title="orms/orms">WEB-LOG</a></li>	
				<li><a href="<%=urlPage%>kaigi/member/logout.jsp" onfocus="this.blur();" title="logout">ログアウト</a></li> 						
				<li><a  href="<%=urlPage%>kaigi/admin/member/listForm.jsp" onfocus="this.blur();"  title="会員管理"> 会員管理 </a></li>									
		<%}else{%>				
				<li><a href="<%=urlPage%>kaigi/member/logout.jsp" onfocus="this.blur();"  title="logout">ログアウト</a></li>				
		<%}%>				
	<%}%>
<%}else{%>			
				<li><a href="<%=urlPage%>kaigi/member/loginForm.jsp" onFocus="this.blur()" title="login">ログイン</a></li>				
<%}%>				
				<li><a  href="<%=urlPage%>kaigi/admin/member/updateForm_admin.jsp?member_id=<%=id%>" onfocus="this.blur();" title="My情報"> My情報</a></li>  
			</ul> 
	<div class="clear"></div>
      </div><!--//top_menu_cont-->           
	   <div class="logo_bottom">
			<div class="logo_bottom_main">
				<div class="logo_bottom_main_left">				   	
				   	<a class="logonav_acc" href="<%=urlPage%>kaigi/admin/schedule/monthForm.jsp" onfocus="this.blur();"  title="会議室予約システム">会議室予約システム</a>			   
				</div>  
				<div class="logo_bottom_main_right">
					<a class="logo_groupware" href="<%=urlPage%>kaigi/admin/schedule/monthForm.jsp" onfocus="this.blur();"  title="会議室予約システム">
					<img src="<%=urlPage%>rms/image/admin_main_top.jpg">	</a>					
					
					<!--<a href="<%=urlPage%>kaigi/admin/admin_main.jsp" onfocus="this.blur();"  title="会議室予約システム">
...
<%if(id !=null && kind.equals("kaigi")){%>     	   
	  <div id="headermenusystem">
		    <div id="cont1">
		      <a class="mtopnav" href="#" onclick="return false;" onmousedown="dropMenu('dropmenu1')" onfocus="this.blur();">予約システム</a>
			      <div id="dropmenu1" class="dropmenus">
			        	<a class="stopnav" href="<%=urlPage%>kaigi/admin/schedule/listForm.jsp"  onfocus="this.blur();">リスト</a>
					<a class="stopnav" href="<%=urlPage%>kaigi/admin/schedule/monthForm.jsp"  onfocus="this.blur();">カレンダー</a> 
			      </div>
		    </div>
...
<%}else{%>	
	 <div id="headermenusystem">
		    <div id="cont1">
		      <a class="mtopnav" href="#" onclick="return false;" onmousedown="dropMenu('dropmenu1')" onfocus="this.blur();">予約システム</a>
			      <div id="dropmenu1" class="dropmenus">
			        <a class="stopnav" href="#" onfocus="this.blur();">リスト</a>
			        <a class="stopnav" href="#" onfocus="this.blur();">カレンダー</a>	        
			      </div>
		    </div>	    
