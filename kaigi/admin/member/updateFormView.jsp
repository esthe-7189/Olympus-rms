...
frm.action = "<%=urlPage%>rms/admin/member/update.jsp";	
frm.submit();
}
//-->
</SCRIPT>
...
<table width="80%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		<td width="100%"  height="30" style="padding: 0 0 0 0"  class="calendar7">
				...
				<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);">会員情報の修正
    		</td>    	
	</tr>		
</table>
...
<form name="memberInput" action="<%=urlPage%>kaigi/admin/member/update.jsp" method="post" >	 
	...
	<td align="center" style="padding: 0 0 30 0">						
		<table width="95%" border=1 cellpadding=1 cellspacing=0 bordercolor=#FFFFFF bordercolorlight=#A2A2A2>	
			...
			<tr>
				...
				<td style="padding: 5 0 0 0" width="80%">
					<INPUT TYPE="password" NAME="password"  VALUE="${member.password}" SIZE="20" maxlength="10"   class="logbox" style="width:100px"><font color="#807265">( 4～8字の半角英数字)</font>
				</td>
			</tr>	
			<tr>
				<td style="padding: 5 0 0 0" width="20%" bgcolor="#F1F1F1"><font color="#CC0000">※</font>パスワード 2 :</td>
				<td style="padding: 5 0 0 0" width="80%">
					<INPUT TYPE="password" NAME="password2"  VALUE="" SIZE="20" maxlength="10"   class="logbox" style="width:100px"><font color="#807265">( 4～8字の半角英数字)</font>
				</td>
			</tr>				
			<tr>
			...
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" bgcolor="#F1F1F1"><font color="#CC0000">※</font>電話(携帯)番号:</td>
			    	<td style="padding: 5 0 0 0"><input type="text" name="tel"  value="${member.tel}"  maxlength="15"  class="logbox" style="width:100px"><font color="#807265">( 例：03-3347-6081)</font>
			    	</td>   
			</tr>
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" bgcolor="#F1F1F1"><img src="<%=urlPage%>rms/image/icon_s.gif" >郵便番号:</td>
			    	<td><input type="text" name="zip"  value="${member.zip}"  maxlength="20"  class="logbox" style="width:80px"><font color="#807265">（半角数字７桁）（例：<img src="<%=urlPage%>rms/image/user/zip_jirusi_03.gif" valign="top">123-0001）</font>
			    	</td>   
			</tr>
		    	<tr>    
				<td style="padding: 5 0 0 0" width="20%" bgcolor="#F1F1F1"><img src="<%=urlPage%>rms/image/icon_s.gif" >住所:</td>
			    	<td><input type="text" name="address"  value="${member.address}"  maxlength="200"  class="logbox" style="width:400px">
			    	</td>   
			</tr>
			<tr>    
			...
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" bgcolor="#F1F1F1"><img src="<%=urlPage%>rms/image/icon_s.gif" >生年月日:</td>
			    	<td><input type="text" name="bir_day"  value="${member.bir_day}"  maxlength="10" class="logbox" style="width:100px;ime-mode:disabled"> <font color="#807265">( 例：0000-00-0000)</font>
			    		
			    	</td>   
			</tr>
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" bgcolor="#F1F1F1"><img src="<%=urlPage%>rms/image/icon_s.gif" >職名:</td>
			    	<td><input type="text" name="position"  value="${member.position}"  maxlength="80"  class="logbox" style="width:250px">
			    	</td>   
			</tr>
			<tr>    
