...
frm.action = "<%=urlPage%>kaigi/admin/member/sign_pop.jsp";	
frm.submit();
}
...
<form name="memberInput" action="<%=urlPage%>kaigi/admin/member/sign_pop.jsp" method="post"   enctype="multipart/form-data">					
