...
<form name="memberInput"  action="<%=urlPage%>kaigi/member/login.jsp" method="post"   >	 
  <tr>
    <td  align="center" valign=middle>
   <table width="656" height="426" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" background="<%=urlPage%>rms/image/user/loginbg_kaigi.jpg">          
...
<script language="JavaScript">
 ...
 function goPage(cookieName){
  ...
  frm.action="<%=urlPage%>kaigi/member/login.jsp";
  frm.submit();
 }
