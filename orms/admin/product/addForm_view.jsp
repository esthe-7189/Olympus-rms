...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#F7F5EF">
		<form action="<%=urlPage%>admin/product/add.jsp" method="post"  name="resultform"  enctype="multipart/form-data">		
						...
						<table width="95%" border=1 cellpadding=1 cellspacing=0 bordercolor=#FFFFFF bordercolorlight=#A2A2A2>
								<tr>
									...
									<td align="left"  style="padding-left:10px"  width="85%">
										<input type="radio" name="category" value="1" checked >自家軟骨細胞									
								...
								<tr>
									...
									<td align="left"  style="padding-left:10px"  >
										<input type="text" NAME="title_m"  VALUE="" SIZE="20" maxlength="120"  class="logbox" style="width:550px">
								...
								<tr>
									<td align="left"  style="padding-left:10px"   bgcolor="#F1F1F1"><font color="#CC0000">※</font>
										サブ　タイトル</td>																	
									<td align="left"  style="padding-left:10px"  >
										<TEXTAREA  name="title_s"  cols="100" rows="5" wrap="hard" ></TEXTAREA>
								...
								<tr>
									...
									<td align="left"  style="padding-left:15px"  >
										...
										<font color="#807265">(▷イメージのサイズは <b>250*190</b>に限って下さい!!)</font>
