...
var frmL = document.formlgroup;
	...
	frmL.action = "<%=urlPage%>admin/info/cateInsert01_view.jsp";	
	frmL.submit();
}
</script>	
<script language="javascript">	
  ...
  var frmCate = document.formcategory;	       	   
	...
	if(isEmpty(frm.title, "タイトルを入力して下さい")) return ;
	 ...
	 frm.cate_L_seq.value=frmCate.lgroup_code.value;
  	 ...
  	 if ( confirm("上の内容を登録しますか?") != 1 ) { return; }	
	 frm.action = "<%=urlPage%>admin/info/add.jsp";	
	 frm.submit();
}
function goInit(){
	var frm = document.formContent;
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#EAE3DE">								
		<tr>
			...
			<font color="#007AC3">(1)</font>  カテゴリ登録及び管理<br></td>			
		</tr>	
</table>			  
<table  width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#F7F5EF">	
	<form name="formlgroup" method="post"  action="<%=urlPage%>admin/info/cateInsert01_view.jsp" onSubmit="return goWrite01(this)" >	
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0"  style="padding-top:10px">
	...
	<tr>
		<td height="10" valign="middle"  width="100%">
			...
			<input type=text size="40" class=input02 readonly name="mgroup_name"> 
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#EAE3DE">								
		<tr>
			<td align="left"  style="padding-left:10px;padding-top:10px" class="calendar9">
			<font color="#007AC3">(2)</font>  コンテンツの登録<br></td>			
		</tr>	
</table>	
<table  width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#F7F5EF">
	<form action="<%=urlPage%>admin/info/add.jsp" method="post"  name="formContent"  onSubmit="return contentWite(this)" >	
			<input type='hidden' name="cate_seq">	
			<input type='hidden' name="cate_L_seq">
			<input type='hidden' name="cate_M_seq">	
		<tr>
						...
						<table width="95%" border=1 cellpadding=1 cellspacing=0 bordercolor=#FFFFFF bordercolorlight=#A2A2A2>																
								<tr>
									...
									<td align="left"  style="padding-left:10px"  >
										<input type="text" NAME="title"  VALUE="" SIZE="20" maxlength="50"  class="logbox" style="width:550px">
...
var delpage= "<%=urlPage%>admin/info/cateDel.jsp";
var listForm="<%=urlPage%>admin/info/cateAddForm.jsp";
var modiOk="<%=urlPage%>admin/info/cateModi.jsp";
