...
JobBean job=manager.getJobItem(Integer.parseInt(seq));
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#F7F5EF">						
	...
	<%category=managerCate.select(job.getCate_L_seq());
	...
	<%}%>
								...
								<tr>
									...
									<td align="left"  style="padding-left:10px"  width="70%">
	<%category=managerCate.select(job.getCate_M_seq());
		if(category!=null){%><%=category.getName()%>
	<%}else{%>No Data
	<%}%>
								...
								<tr>
									...
									<td align="left"  style="padding-left:10px">${job.title}</td>
								</tr>								
								<tr>
									<td align="left"  style="padding-left:10px"   bgcolor="#F1F1F1">
									<img src="<%=urlPage%>images/common/ArrowNews.gif" >ユーザーのページで見える</td>
									<td align="left"  style="padding-left:10px">
									<c:if test="${job.view_yn==1}">はい</c:if>
									<c:if test="${job.view_yn==2}">いいえ</c:if>	
									</td>																	
								</tr>			
					</table>
				</td>
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#F7F5EF">		
				...
				<tr>
					<td>											
						<table width="95%"  border=1 cellpadding=1 cellspacing=0 bordercolor=#FFFFFF bordercolorlight=#A2A2A2>										
							<tr>
								<td style="padding-bottom:10px;padding-top:10px"  width="100%" bgcolor="#ffffff" align="left">${job.content}</td>							
							</tr>
						</table>
					</td>			
				</tr>									 		
