...
function goWrite03(groupId3,parentId3){	
	...
	document.move.action = "<%=urlPage%>admin/job/cateInsert03_view.jsp";	
...
<form name="formsgroup" method=post action="<%=urlPage%>admin/job/cateInsert03_view.jsp" onSubmit="return goWrite03(this)" >		
...
var delpage= "<%=urlPage%>admin/job/cateDel_03.jsp";
var modiOk="<%=urlPage%>admin/job/cateModi_03.jsp";
