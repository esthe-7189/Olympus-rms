...
function goWrite02(){	
	...
	document.move.action = "<%=urlPage%>admin/job/cateInsert02_view.jsp";	
...
<form name="formmgroup" method=post action="<%=urlPage%>admin/job/cateInsert02_view.jsp" onSubmit="return goWrite02(this)" >		
...
var delpage= "<%=urlPage%>admin/job/cateDel_02.jsp";
var listForm="<%=urlPage%>admin/job/cateAddForm.jsp";
var modiOk="<%=urlPage%>admin/job/cateModi_02.jsp";
