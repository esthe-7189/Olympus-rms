...
frm.action = "<%=urlPage%>admin/news/update.jsp";	
frm.submit();	
...
<c:if test="${! empty news}">					  
<table  width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#F7F5EF">
		<form action="<%=urlPage%>admin/product/update.jsp" method="post"  name="resultform"  >
			<input type="hidden" name="seq" value="${news.seq}">		
		<tr>
			<td align="left"  width="15%"  style="padding-left:30px;padding-top:10px" class="calendar9">
				<img src="<%=urlPage%>images/common/ArrowNews.gif">
				<img src="<%=urlPage%>images/common/ArrowNews.gif" style="filter:Alpha(Opacity=60);">書き直し</td>
						...
						<table width="95%" border=1 cellpadding=1 cellspacing=0 bordercolor=#FFFFFF bordercolorlight=#A2A2A2>																
								<tr>
									...
									<td align="left"  style="padding-left:10px"  >
										<input type="text" NAME="title"  VALUE="${news.title}" SIZE="20" maxlength="120"  class="logbox" style="width:550px">
