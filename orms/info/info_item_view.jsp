...
<img src="<%=urlPage%>images/common/overay.gif"/><a href="<%=urlPage%>info/infoSub.jsp"> 関連情報 </a>
<img src="<%=urlPage%>images/common/overay.gif"/> <%=ltitle%>
<img src="<%=urlPage%>images/common/overay.gif"/> <%=mtitle%></p>
	
<p id="catetop" class="b fs14 l18 pad_t10 mb20"><a href="<%=urlPage%>info/infoSub.jsp"><img src="<%=urlPage%>images/menu/menu_03.gif" ></a>
