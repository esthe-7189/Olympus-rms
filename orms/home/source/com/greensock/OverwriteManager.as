 ...
 * 					
 * 		<li><b> AUTO (2):</b> Searches for and overwrites only individual overlapping properties in tweens that are running at 
 * 						the time the tween begins (this is the default mode for TweenMax). If all tweening properties have been overwritten in a tween, 
 * 						the whole tween will automatically be killed (meaning onComplete, onUpdate, etc. won't fire). <br /><code>
 * 				
 * 						TweenLite.to(mc, 1, {x:100, y:200});<br />
 ...
 */	 
	public class OverwriteManager {
		/** @private **/
		public static const version:Number = 5.42;
