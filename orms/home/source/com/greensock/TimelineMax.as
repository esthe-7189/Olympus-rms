 ...
 * 	
 * <ul>
 * 		<li> build sequences easily by adding tweens with the append(), prepend(), insert(), 
 * 			 appendMultiple(), prependMultiple(), and insertMultiple() methods.</li>
 * 
 ...
 * 	<li> TimelineMax adds about 4.5k to your SWF including OverwriteManager.</li>
 * </ul>
 * 
 ...
 **/
	public class TimelineMax extends TimelineLite implements IEventDispatcher {
		 ...
		 * 
		 * <ul>
		 * 	<li><b> delay : Number</b>				Amount of delay before the timeline should begin (in seconds unless <code>useFrames</code> is set 
