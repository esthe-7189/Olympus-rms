...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Find','Replace','-','SelectAll','-','Link','Unlink'],
	['FitWindow','-','About'],
	'/',	
...
FCKConfig.ToolbarSets["Basic02"] = [
    ['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About','TextColor','BGColor'],
	['Style','FontFormat','FontName','FontSize','Image']
] ;
...
// FCKConfig.FontNames		= 'µ∏¿Ω;πŸ≈¡;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;

FCKConfig.FontNames		= 'MS PGothic;MS Gothic;Gulim;Dotum;Batang;Gungsuh;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
