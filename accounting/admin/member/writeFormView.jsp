...
frm.action = "<%=urlPage%>accounting/admin/member/memberOk.jsp";	
frm.submit();
}
//-->
</SCRIPT>
...
<form name="memberInput" action="<%=urlPage%>accounting/admin/member/memberOk.jsp" method="post" >
	 ...
	 <input type="hidden" name="CHECKED_EMAIL">
			<tr>
				...
				<td style="padding: 5 0 0 0" width="80%">
					<input type="text" name="nm"  value=""  maxlength="20"  class="input02" style="width:100px">
				</td>
			</tr>	
			<tr>
			...
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" ><font color="#CC0000">※</font><span class="titlename">電話(携帯)番号:</span></td>
			    	<td style="padding: 5 0 0 0"><input type="text" name="tel"  value=""  maxlength="15"  class="input02" style="width:100px"><font color="#807265">( 例：03-3347-6081)</font>
			    	</td>   
			</tr>
			<tr>    
				...
				<td style="padding: 5 0 0 0" width="20%" ><img src="<%=urlPage%>rms/image/icon_s.gif" ><span class="titlename">住所:</span></td>
			    	<td><input type="text" name="address"  value=""  maxlength="200"  class="input02" style="width:250px">
			    	</td>   
			</tr>
			<tr>    
			...
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" ><img src="<%=urlPage%>rms/image/icon_s.gif" ><span class="titlename">職名:</span></td>
			    	<td><input type="text" name="position"  value=""  maxlength="80"  class="input02" style="width:250px">
			    	</td>   
			</tr>
			<tr>    
				...
				<td style="padding: 5 0 0 0" width="20%"  colspan="2">
					-秘密の質問を選択して下さい:
						<select name="himithu_1">
							...
							-秘密の答えを書いてください:<input type="text" name="himithu_2"  value=""  maxlength="50"  class="input02" style="width:130px">
