...
String urlPage2="https://olympus-rms.com/";
	...
	if(cookies != null){
    		for(int i = 0; i < cookies.length; i++){
     			if(cookies[i].getName().equals("idNameAcc")){      
				cheOk=2;
...
<form name="memberInput" action="<%=urlPage%>accounting/member/login.jsp" method="post"    >	 
  <tr>
    <td  align="center" valign=middle>
   <table width="656" height="426" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" background="<%=urlPage%>rms/image/user/loginbg.jpg">    		
...
<script language="JavaScript">
 ...
 function goPage(cookieName){
  ...
  frm.action="<%=urlPage%>accounting/member/login.jsp";
  frm.submit();
 }
