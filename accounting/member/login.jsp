...
<%}else if(member_yn==2 || member_yn==0){
	...
	if(idSave.equals("save")){		
		response.addCookie(CookieBox.createCookie("idNameAcc",member_id,"/",60*60*24*365));
	}	

%>
			
	<jsp:forward page="/rms/template/tempMain.jsp">		    
		<jsp:param name="CONTENTPAGE3" value="/accounting/member/loginView.jsp" />	
	</jsp:forward>
<%}%>