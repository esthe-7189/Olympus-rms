...
<center>
	...
	<table width="100%"  border="0" cellpadding=1 cellspacing=0 >
			<tr>
				<td align="center"  class="calendar15" style="padding: 10px 0px 0px 0px">決裁書/契約書文書ファイル一覧</td>							
			</tr>		
	</table>
...
%>				
	<tr>	    
	    	<td  align="center"><%=aadd%></td>
		<td><%=pdb.getCate_nm()%></td>	
		<td><%=pdb.getTitle()%></td>				
		<td>	<%if(pdb.getView_yn()==0){%><%=pdb.getFilename()%> 	<%}else{%>--	<%}%></td>
		<td><%=pdb.getComment()%></td>		
	</tr>			
<% }
i++;	
}
