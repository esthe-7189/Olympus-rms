...
frm.action = "<%=urlPage%>tokubetu/admin/member/updateView_admin.jsp";	
frm.submit();
}
//-->
</SCRIPT>
...
<img src="<%=urlPage%>rms/image/icon_ball.gif" style="filter:Alpha(Opacity=30);"><span class="calendar7">会員管理  情報修正</span> 
...
<label class="calendar9">
			<img src="<%=urlPage%>rms/image/icon_s.gif" >	次の内容を書いてください！！
</label>		

	
<!-- 내용 시작 *****************************************************************-->
<table width="800"  class="tablebox" cellspacing="5" cellpadding="5" >
<form name="memberInput" action="<%=urlPage%>tokubetu/admin/member/updateView_admin.jsp" method="post" >	 
	 ...
	 <input type="hidden" name="member_id" value="${member.member_id}">				
		<tr>
			...
			<tr>
				<td style="padding: 5 0 0 0" width="20%" ><font color="#CC0000">※</font>パスワード 2 :</td>
				<td style="padding: 5 0 0 0" width="80%">
			...
			<tr>
				<td style="padding: 5 0 0 0" width="20%" ><font color="#CC0000">※</font>メールアドレス :</td>
				<td style="padding: 5 0 0 0" width="80%">
			...
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" ><font color="#CC0000">※</font>電話(携帯)番号:</td>
			...
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" ><img src="<%=urlPage%>rms/image/icon_s.gif" >郵便番号:</td>
		    	...
		    	<tr>    
				<td style="padding: 5 0 0 0" width="20%" ><img src="<%=urlPage%>rms/image/icon_s.gif" >住所:</td>
			    	<td><input type="text" name="address"  value="${member.address}"  maxlength="200"  class="input02" style="width:400px">
			    	</td>   
			</tr>
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" ><img src="<%=urlPage%>rms/image/icon_s.gif" >性別:</td>
			    	<td>
			...
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" ><img src="<%=urlPage%>rms/image/icon_s.gif" >生年月日:</td>
			    	<td><input type="text" name="bir_day"  value="${member.bir_day}"  maxlength="10" class="input02" style="width:100px;ime-mode:disabled"> <font color="#807265">( 例：0000-00-0000)</font>
			    		
			    	</td>   
			</tr>
			<tr>    
				<td style="padding: 5 0 0 0" width="20%" ><img src="<%=urlPage%>rms/image/icon_s.gif" >職名:</td>
