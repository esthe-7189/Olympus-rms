...
int dbNo=mgr.checkKanri(kanriNoVal,Integer.parseInt(kubun_bseq)); 
//관리번호 중복 체크      	
if(dbNo==-1){	
%>
...
<%
		...
		response.sendRedirect(urlPage+"tokubetu/admin/contract/listForm.jsp");
}else{
%>
	<script language="JavaScript">
		alert("既に登録された管理番号です。もう一度確認して下さい。");
	  	location.href = "<%=urlPage%>tokubetu/admin/contract/addForm.jsp";		
	</script>
<%}%>