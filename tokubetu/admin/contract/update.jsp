...
String urlPage=request.getContextPath()+"/";
	...
	//String saveFold="C:\\dev\\tomcat5\\webapps\\orms\\tokubetu\\fileList\\contract";
	String saveFoldTemp="/home/user/orms/public_html/rms/temp";
	String saveFold="/home/user/orms/public_html/tokubetu/fileList/contract";
...
String kanriNoVal="契-"+kanri_no;

ContractMgr mgr=ContractMgr.getInstance();
int allCnt=mgr.checkKanriUpCnt(kanriNoVal,Integer.parseInt(kubun_bseq)); 
int seqCnt=mgr.checkKanriUpBseq(kanriNoVal,Integer.parseInt(bseq),Integer.parseInt(kubun_bseq)); 
...
<%}else{%>
	<script language="JavaScript">
		alert("既に登録された管理番号です。もう一度確認して下さい。");
	  	location.href = "<%=urlPage%>tokubetu/admin/contract/updateForm.jsp?seq=<%=bseq%>&read=update";	
	</script>	
<%}%>
